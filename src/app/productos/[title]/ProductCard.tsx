...
const ProductCard = ({ product }: { product: Product }) => {
  ...
  return (
    ...
    >
      ...
      <CardFooter className="flex flex-col items-start px-4 md:px-6 lg:px-10 pt-6 pb-10 lg:py-14 2xl:py-20 gap-3 xs:gap-4
      md:gap-5 2xl:gap-6
      text-negro sm:w-3/5">
        <Breadcrumbs
          classNames={{
        ...
        <h3 className="font-semibold text-xl xs:text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl 3xl:text-6xl">${product.price}</h3>
        <p className="text-sm xs:text-base lg:text-lg 2xl:text-xl">Para comprarlas, comunicate por:</p>
